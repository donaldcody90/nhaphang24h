    ...
    class Redux_Framework_sample_config {
        ...
        public function setSections() {
            ...
            // ACTUAL DECLARATION OF SECTIONS
             ...
             $this->sections[] = array(
                'title' => __('Header Settings', 'wpf-framework-demo'),
                ...
                /*array(
                        ...
                        'type' => 'section',
                        'title' => __('Media Options', 'wpf-framework-demo'),
                        'subtitle' => __('With the "section" field you can create indent option sections.', 'wpf-framework-demo'),
                    ...
                    array(
                        ...
                        'desc' => __('Basic media uploader with disabled URL input field.', 'wpf-framework-demo'),
                        'subtitle' => __('Upload any media using the WordPress native uploader', 'wpf-framework-demo'),
                  ...
                  /*  array(
                    ...
                    array(
                        'id' => 'switch-menu',
                        'type' => 'switch',
                        'title' => __('Enable Custom Menu', 'wpf-framework-demo'),
                        'subtitle' => __('Look, it\'s on! Also hidden child elements!', 'wpf-framework-demo'),
                        "default" => 0,
                        'on' => 'Enabled',
                        'off' => 'Disabled',
                    ),
                    ...
                    array(
                        'id' =>'menu-small-text-1',
                        'type' => 'text',
                        'required' => array('switch-menu', '=', '1'),
                        'title' => __('First Header Menu Small Text', 'wpf-framework-demo'),
                        'subtitle' => __('This must be a alpha numeric only.', 'wpf-framework-demo'),
                        //'desc' => __('This is the description field, again good for additional info.', 'wpf-framework-demo'),
                    ...
                    array(
                        ...
                        'type' => 'text',
                        'required' => array('switch-menu', '=', '1'),
                        'title' => __('First Header Menu Big Text', 'wpf-framework-demo'),
                        'subtitle' => __('This must be a alpha numeric only.', 'wpf-framework-demo'),
                        //'desc' => __('This is the description field, again good for additional info.', 'wpf-framework-demo'),
                        'validate' => 'no_special_chars',
                        'default' => 'MENU'
                     ...
                     array(
                        ...
                        'type' => 'text',
                        'required' => array('switch-menu', '=', '1'),
                        'title' => __('Enter the menu link', 'wpf-framework-demo'),
                        //'subtitle' => __('This must be a alpha numeric only.', 'wpf-framework-demo'),
                        //'desc' => __('This is the description field, again good for additional info.', 'wpf-framework-demo'),
                        //'validate' => 'no_special_chars',
                        //'default' => 'Enter desired link'
                    ),
                    array(
                        'id' => 'section-child_menu-start',
                        'type' => 'section',
                        'title' => __('Child of Our Menu Options', 'wpf-framework-demo'),
                        'subtitle' => __('With the "section" field you can create indent option sections.', 'wpf-framework-demo'),
                        'indent' => true // Indent all options below until the next 'section' option is set.
                    ),
                     array(
                        'id' =>'menu1_child1_text',
                        'type' => 'text',
                        'required' => array('switch-menu', '=', '1'),
                        'title' => __('First Child Our Menu', 'wpf-framework-demo'),
                        'subtitle' => __('This must be a alpha numeric only.', 'wpf-framework-demo'),
                        //'desc' => __('This is the description field, again good for additional info.', 'wpf-framework-demo'),
                        'validate' => 'no_special_chars',
                        'default' => 'ARIZONA MENU'
                    ),
                     array(
                        'id' => 'menu1_child1_link',
                        'type' => 'text',
                        'required' => array('switch-menu', '=', '1'),
                        'title' => __('Enter the menu link', 'wpf-framework-demo'),
                        //'subtitle' => __('This must be a alpha numeric only.', 'wpf-framework-demo'),
                      ...
                      array(
                        'id' =>'menu1_child2_text',
                        'type' => 'text',
                        'required' => array('switch-menu', '=', '1'),
                        'title' => __('Second Child Our Menu', 'wpf-framework-demo'),
                        'subtitle' => __('This must be a alpha numeric only.', 'wpf-framework-demo'),
                        //'desc' => __('This is the description field, again good for additional info.', 'wpf-framework-demo'),
                        'validate' => 'no_special_chars',
                        'default' => 'NEW MEXICO MENU'
                    ),
                     array(
                        'id' => 'menu1_child2_link',
                        'type' => 'text',
                        'required' => array('switch-menu', '=', '1'),
                        'title' => __('Enter the menu link', 'wpf-framework-demo'),
                        //'subtitle' => __('This must be a alpha numeric only.', 'wpf-framework-demo'),
                      ...
                      array(
                        'id' =>'menu1_child3_text',
                        'type' => 'text',
                        'required' => array('switch-menu', '=', '1'),
                        'title' => __('Third Child Our Menu', 'wpf-framework-demo'),
                        'subtitle' => __('This must be a alpha numeric only.', 'wpf-framework-demo'),
                        //'desc' => __('This is the description field, again good for additional info.', 'wpf-framework-demo'),
                        'validate' => 'no_special_chars',
                     ...
                     array(
                        'id' => 'section-child_menu-end',
                        'type' => 'section',
                        'indent' => false // Indent all options below until the next 'section' option is set.
                    ),

                    array(
                        'id' =>'menu-small-text-2',
                        'type' => 'text',
                        'required' => array('switch-menu', '=', '1'),
                        'title' => __('Second Header Menu Small Text', 'wpf-framework-demo'),
                        'subtitle' => __('This must be a alpha numeric only.', 'wpf-framework-demo'),
                        //'desc' => __('This is the description field, again good for additional info.', 'wpf-framework-demo'),
                        'validate' => 'no_special_chars',
                        'default' => 'LOCATION'
                    ...
                    array(
                        ...
                        'type' => 'text',
                        'required' => array('switch-menu', '=', '1'),
                        'title' => __('Second Header Menu Big Text', 'wpf-framework-demo'),
                        'subtitle' => __('This must be a alpha numeric only.', 'wpf-framework-demo'),
                        //'desc' => __('This is the description field, again good for additional info.', 'wpf-framework-demo'),
                        'validate' => 'no_special_chars',
                        'default' => 'FINDER'
                    ...
                    array(
                        'id' =>'menu-small-text-3',
                        'type' => 'text',
                        'required' => array('switch-menu', '=', '1'),
                        'title' => __('Third Header Menu Small Text', 'wpf-framework-demo'),
                        'subtitle' => __('This must be a alpha numeric only.', 'wpf-framework-demo'),
                        //'desc' => __('This is the description field, again good for additional info.', 'wpf-framework-demo'),
                        'validate' => 'no_special_chars',
                        'default' => 'GREAT'
                    ...
                    array(
                        ...
                        'type' => 'text',
                        'required' => array('switch-menu', '=', '1'),
                        'title' => __('Third Header Menu Big Text', 'wpf-framework-demo'),
                        'subtitle' => __('This must be a alpha numeric only.', 'wpf-framework-demo'),
                        //'desc' => __('This is the description field, again good for additional info.', 'wpf-framework-demo'),
                        'validate' => 'no_special_chars',
                        'default' => 'COUPONS'
            ...
            $this->sections[] = array(
                'title' => __('Home Page Settings', 'wpf-framework-demo'),
                'desc' => __('Home Page Widget options', 'wpf-framework-demo'),
                'icon' => 'el-icon-home',
                // 'submenu' => false, // Setting submenu to false on a given section will hide it from the WordPress sidebar menu!
                'fields' => array(
                    array(
                            'id'          => 'homepage_typography',
                            'type'        => 'typography', 
                ...
                array(
                        'id' => 'Homepage_widget1-start',
                        'type' => 'section',
                        'title' => __('Homepage Combos Widget', 'wpf-framework-demo'),
                        'subtitle' => __('', 'wpf-framework-demo'),
                        'indent' => true // Indent all options below until the next 'section' option is set.
                    ), 
                     array(
                        'id' => 'widget_title-1',
                        'type' => 'text',
                        'title' => __('Text Option - No Special Chars Validated', 'wpf-framework-demo'),
                        //'subtitle' => __('This must be a alpha numeric only.', 'wpf-framework-demo'),
                        //'desc' => __('This is the description field, again good for additional info.', 'wpf-framework-demo'),
                        'validate' => 'no_special_chars',
                        'default' => '0'
                    ...
                    array(
                        ...
                        'type' => 'media',
                        'url' => true,
                        'title' => __('Combos Image', 'wpf-framework-demo'),
                        'compiler' => 'true',
                       ),
                     array(
                        'id' => 'widget1_link',
                        'type' => 'text',
                        'title' => __('Enter the Combos link', 'wpf-framework-demo'),
                        //'subtitle' => __('This must be a alpha numeric only.', 'wpf-framework-demo'),
                        //'desc' => __('This is the description field, again good for additional info.', 'wpf-framework-demo'),
                        //'validate' => 'no_special_chars',
                        //'default' => 'sired link'
                    ...
                    array(
                        'id' => 'Homepage_widget1-end',
                        'type' => 'section',
                        'indent' => false // Indent all options below until the next 'section' option is set.
                        ),  
                    array(
                        'id' => 'Homepage_widget2-start',
                        'type' => 'section',
                        'title' => __('Homepage Specials Widget', 'wpf-framework-demo'),
                        'subtitle' => __('', 'wpf-framework-demo'),
                        'indent' => true // Indent all options below until the next 'section' option is set.
                    ), 
                     array(
                    ...
                    array(
                        ...
                        'type' => 'media',
                        'url' => true,
                        'title' => __('Specials Image', 'wpf-framework-demo'),
                        'compiler' => 'true',
                       ),
                     array(
                        'id' => 'widget2_link',
                        'type' => 'text',
                        'title' => __('Enter the Specials link', 'wpf-framework-demo'),
                        //'subtitle' => __('This must be a alpha numeric only.', 'wpf-framework-demo'),
                        //'desc' => __('This is the description field, again good for additional info.', 'wpf-framework-demo'),
                        //'validate' => 'no_special_chars',
                        //'default' => 'Enter desired link'
                    ...
                    array(
                        'id' => 'Homepage_widget2-end',
                        'type' => 'section',
                        'indent' => false // Indent all options below until the next 'section' option is set.
                        ),                  
                    
                    array(
                        'id' => 'Homepage_widget3-start',
                        'type' => 'section',
                        'title' => __('Homepage Facebook Widget', 'wpf-framework-demo'),
                        'subtitle' => __('', 'wpf-framework-demo'),
                        'indent' => true // Indent all options below until the next 'section' option is set.
                    ), 
                     array(
                    ...
                    array(
                        ...
                        'type' => 'media',
                        'url' => true,
                        'title' => __('Facebook Image', 'wpf-framework-demo'),
                        'compiler' => 'true',
                       ),
                     array(
                        'id' => 'widget3_link',
                        'type' => 'text',
                        'title' => __('Enter the Facebook link', 'wpf-framework-demo'),
                        //'subtitle' => __('This must be a alpha numeric only.', 'wpf-framework-demo'),
                        //'desc' => __('This is the description field, again good for additional info.', 'wpf-framework-demo'),
                        //'validate' => 'no_special_chars',
                        //'default' => 'Enter desired link'
                    ...
                    array(
                     ...
                     $this->sections[] = array(
                'title' => __('Typography Settings', 'wpf-framework-demo'),
                'desc' => __('Typography options', 'wpf-framework-demo'),
                'icon' => 'el-icon-font',
                // 'submenu' => false, // Setting submenu to false on a given section will hide it from the WordPress sidebar menu!
                'fields' => array(
                    array(
                            ...
                            'type'        => 'typography', 
                            'title'       => __('Typography for Top Menu', 'redux-framework-demo'),
                            'google'      => true, 
                            'text-align'  => false,
                            'font-weight' => false,
							'font-style'  => false,
							'font-size'   => false, 
							'line-height' => false,
                            'subtitle'    => __('Typography option for Top header Menu.', 'redux-framework-demo'),
                            'default'     => array(
                                'color'       => '#000', 
                    ...
                    array(
                            'id'          => 'h1_typography',
                            'type'        => 'typography', 
                            'title'       => __('Typography for h1', 'redux-framework-demo'),
                            'google'      => true, 
                            'text-align'  => false,
                            'font-weight' => false,
							'font-style'  => false,
							'font-size'   => false, 
							'line-height' => false,
                            'subtitle'    => __('Typography option h1.', 'redux-framework-demo'),
                            'default'     => array(
                                'color'       => '#ab252c', 
                                'font-family' => 'Helvetica', 
                                'google'      => true,
                     ...
                     array(
                            'id'          => 'h2_typography',
                            'type'        => 'typography', 
                            'title'       => __('Typography for h2', 'redux-framework-demo'),
                            'google'      => true, 
                            'text-align'  => false,
                            'font-weight' => false,
							'font-style'  => false,
							'font-size'   => false, 
							'line-height' => false,
                            'subtitle'    => __('Typography option for h2.', 'redux-framework-demo'),
                     ...
                     array(
                            'id'          => 'h3_typography',
                            'type'        => 'typography', 
                            'title'       => __('Typography for h3', 'redux-framework-demo'),
                            'google'      => true, 
                            'text-align'  => false,
                            'font-weight' => false,
							'font-style'  => false,
							'font-size'   => false, 
							'line-height' => false,
                            'subtitle'    => __('Typography option for h3.', 'redux-framework-demo'),
                            'default'     => array(
                                'color'       => '#333', 
                                'font-family' => 'Abel', 
                                'google'      => true,
                      ...
                      array(
                            'id'          => 'h4_typography',
                            'type'        => 'typography', 
                            'title'       => __('Typography for h4', 'redux-framework-demo'),
                            'google'      => true, 
                            'text-align'  => false,
                            'font-weight' => false,
							'font-style'  => false,
							'font-size'   => false, 
							'line-height' => false,
                            'subtitle'    => __('Typography option for h4.', 'redux-framework-demo'),
                            'default'     => array(
                                'color'       => '#333', 
                                'font-family' => 'Abel', 
                                'google'      => true,
                        ...
                        array(
                            'id'          => 'h5_typography',
                            'type'        => 'typography', 
                            'title'       => __('Typography for h5', 'redux-framework-demo'),
                            'google'      => true, 
                            'text-align'  => false,
                            'font-weight' => false,
							'font-style'  => false,
							...
							'line-height' => false,
                            'units'       => 'px',
                            'subtitle'    => __('Typography option for h5', 'redux-framework-demo'),
                            'default'     => array(
                                'color'       => '#333',
                                'font-family' => 'Abel', 
                                'google'      => true,
                         ...
                         array(
                            'id'          => 'h6_typography',
                            'type'        => 'typography', 
                            'title'       => __('Typography for h6', 'redux-framework-demo'),
                            'google'      => true, 
                            'text-align'  => false,
                            'font-weight' => false,
							'font-style'  => false,
							'font-size'   => false, 
							'line-height' => false,
                            'subtitle'    => __('Typography option for h6.', 'redux-framework-demo'),
                            'default'     => array(
                                'color'       => '#333', 
                                'font-family' => 'Abel', 
                                'google'      => true,
                        ...
                        array(
                            'id'          => 'text_typography',
                            'type'        => 'typography', 
                            'title'       => __('Typography for Text', 'redux-framework-demo'),
                            'google'      => true, 
                            'text-align'  => false,
                            'font-weight' => false,
							'font-style'  => false,
							'font-size'   => false, 
							'line-height' => false,
                            'subtitle'    => __('Typography option for Text.', 'redux-framework-demo'),
                            'default'     => array(
                                'color'       => '#333', 
                                'font-family' => 'Abel', 
                                'google'      => true,
                        ...
                        array(
                            'id'          => 'white_text_typography',
                            'type'        => 'typography', 
                            'title'       => __('Typography for footer', 'redux-framework-demo'),
                            'google'      => true, 
                            'text-align'  => false,
                            'font-weight' => false,
							'font-style'  => false,
							'font-size'   => false, 
							'line-height' => false,
                            'subtitle'    => __('Typography option for footer.', 'redux-framework-demo'),
                            'default'     => array(
                                'color'       => '#ffffff', 
                                'font-family' => 'Helvetica', 
                                'google'      => true,
                          ...
                          array(
                            'id'          => 'cat_menu_typography',
                            'type'        => 'typography', 
                            'title'       => __('Typography for Category Menu', 'redux-framework-demo'),
                            'google'      => true, 
                            'text-align'  => false,
                            'font-weight' => false,
							'font-style'  => false,
							'font-size'   => false, 
							'line-height' => false,
                            'subtitle'    => __('Typography option for Category Menu.', 'redux-framework-demo'),
                            'default'     => array(
                                'color'       => '#ffffff',
                                'font-family' => 'Neucha', 
                                'google'      => true,
                          ...
                          array(
                            'id'          => 'dish_typography',
                            'type'        => 'typography', 
                            'title'       => __('Typography for Dish name and price', 'redux-framework-demo'),
                            'google'      => true, 
                            'text-align'  => false,
                            'font-weight' => false,
							'font-style'  => false,
							'font-size'   => false, 
							'line-height' => false,
                            'subtitle'    => __('Typography option for Dish name and price.', 'redux-framework-demo'),
                            'default'     => array(
                                'color'       => '#000',
                                'font-family' => 'Oswald', 
                                'google'      => true,
                          ...
                          array(
                            'id'          => 'modal_dish_typography',
                            'type'        => 'typography', 
                            'title'       => __('Typography for Dish name and price in lightbox', 'redux-framework-demo'),
                            'google'      => true, 
                            'text-align'  => false,
                            'font-weight' => false,
							'font-style'  => false,
							'font-size'   => false, 
							'line-height' => false,
                            'subtitle'    => __('Typography option for Dish name and price in lightbox.', 'redux-framework-demo'),
                            'default'     => array(
                                'color'       => '#000',
                                'font-family' => 'Oswald', 
                                'google'      => true,
            ...
            $this->sections[] = array(
                            'title' => __('Contact Us Page Settings', 'wpf-framework-demo'),
                            'desc' => __('Contact Us Page Widget options', 'wpf-framework-demo'),
                            ...
                            'fields' => array(
                                 array(
                                    'id' => 'sw-page_tab',
                                    'type' => 'switch',
                                    'title' => __('Enable Paged/Tabbed Content', 'wpf-framework-demo'),
                                    'subtitle' => __('Look, it\'s on! Also hidden child elements!', 'wpf-framework-demo'),
                                    "default" => 0,
                                    'on' => 'Enabled',
                                    'off' => 'Disabled',
                                ...
                                array(
                                    'id' => 'contact_widget1-start',
                                    'type' => 'section',
                                    'required' => array('sw-page_tab', '=', '1'),
                                    'title' => __('Company History Widget', 'wpf-framework-demo'),
                                    'subtitle' => __('', 'wpf-framework-demo'),
                                    'indent' => true // Indent all options below until the next 'section' option is set.
                                ), 
                                ...
                                array(
                                            'id'=>'company_title_1',
                                            'type' => 'text',
                                            'title' => __('Company Tab Title', 'redux-framework-demo'), 
                                    ...
                                    array(
                                            'id'=>'company_history',
                                            'type' => 'textarea',
                                            'title' => __('Company History Widget Text', 'redux-framework-demo'), 
                                            //'subtitle' => __('Custom HTML Allowed (wp_kses)', 'redux-framework-demo'),
                                            //'desc' => __('This is the description field, again good for additional info.', 'redux-framework-demo'),
                                            'validate' => 'html_custom',
                                            'default' => '<br />Some HTML is allowed in here.<br />',
                                           ...
                                           array(
                                                    'id'               => 'company_history_content',
                                                    'type'             => 'editor',
                                                    'title'            => __('Company History Content', 'redux-framework-demo'), 
                                        ...
                                        array(
                                            'id' => 'contact_widget2-start',
                                            'type' => 'section',
                                            'required' => array('sw-page_tab', '=', '1'),
                                            'title' => __('Your Feedback Widget', 'wpf-framework-demo'),
                                            'subtitle' => __('', 'wpf-framework-demo'),
                                            'indent' => true // Indent all options below until the next 'section' option is set.
                                        ), 
                                        ...
                                        array(
                                            'id'=>'your_feedback',
                                            'type' => 'textarea',
                                            'title' => __('Your Feedback Widget Text', 'redux-framework-demo'), 
                                            //'subtitle' => __('Custom HTML Allowed (wp_kses)', 'redux-framework-demo'),
                                                //'desc' => __('This is the description field, again good for additional info.', 'redux-framework-demo'),
                                                'validate' => 'html_custom',
                                                'default' => '<br />Some HTML is allowed in here.<br />',
                                               ...
                                               /*array(
                                                        'id'               => 'your_feedback_content',
                                                        'type'             => 'editor',
                                                        'title'            => __('Your Feedback Content', 'redux-framework-demo'), 
                                                        //'subtitle'         => __('Subtitle text would go here.', 'redux-framework-demo'),
                                                        //'default'          => 'Powered by Redux.',
                                                        'editor_options'   => array(
                                                            'teeny'            => true,
                                            ...
                                            array(
                                                'id' => 'feedback_link',
                                                'type' => 'text',
                                                'title' => __('Enter the Feedback link', 'wpf-framework-demo'),
                                                //'subtitle' => __('This must be a alpha numeric only.', 'wpf-framework-demo'),
                                                //'desc' => __('This is the description field, again good for additional info.', 'wpf-framework-demo'),
                                                //'validate' => 'no_special_chars',
                                                //'default' => 'Enter desired link'
                                            ...
                                            array(
                                                'id' => 'contact_widget2-end',
                                                'type' => 'section',
                                                'indent' => false // Indent all options below until the next 'section' option is set.
                                                ),
                                                
                                            array(
                                                'id' => 'contact_widget3-start',
                                                'type' => 'section',
                                                'required' => array('sw-page_tab', '=', '1'),
                                                'title' => __('Contact Us Widget', 'wpf-framework-demo'),
                                                'subtitle' => __('', 'wpf-framework-demo'),
                                                'indent' => true // Indent all options below until the next 'section' option is set.
                                            ), 
                                            ...
                                            array(
                                                'id'=>'contact_us',
                                                'type' => 'textarea',
                                                'title' => __('Contact Us Widget Text', 'redux-framework-demo'), 
                                                //'subtitle' => __('Custom HTML Allowed (wp_kses)', 'redux-framework-demo'),
                                                //'desc' => __('This is the description field, again good for additional info.', 'redux-framework-demo'),
                                                'validate' => 'html_custom',
                                                'default' => '<br />Some HTML is allowed in here.<br />',
                                                'allowed_html' => array(
                                                 ...
                                                 array(
                                                        'id'               => 'contact_us_content',
                                                        'type'             => 'editor',
                                                        'title'            => __('Contact Us Content', 'redux-framework-demo'), 
                                                        //'subtitle'         => __('Subtitle text would go here.', 'redux-framework-demo'),
                                                        //'default'          => 'Powered by Redux.',
                                                        'editor_options'   => array(
                                                            'teeny'            => true,
              ...
              $this->sections[] = array(
                'title' => __('Footer Settings', 'wpf-framework-demo'),
                'desc' => __('Footer area options', 'wpf-framework-demo'),
                'icon' => 'el-icon-star',
                // 'submenu' => false, // Setting submenu to false on a given section will hide it from the WordPress sidebar menu!
                'fields' => array(
                 array(
...
/*
                $this->sections[] = array(
                'title' => __('Menu Pages Notes Settings', 'wpf-framework-demo'),
                'desc' => __('Menu Pages Notes area options', 'wpf-framework-demo'),
                //'icon' => 'el-icon-home',
                // 'submenu' => false, // Setting submenu to false on a given section will hide it from the WordPress sidebar menu!
                'fields' => array(
                 array(
                        'id'        => 'arizonamenu_notes',
                        'type'      => 'editor',
                        'title'     => __('Arizona Menu Notes', 'redux-framework-demo'),
                        //'subtitle'  => __('You can use the following shortcodes in your footer text: [wp-url] [site-url] [theme-url] [login-url] [logout-url] [site-title] [site-tagline] [current-year]', 'redux-framework-demo'),
                        //'default'   => 'Powered by Redux Framework.',
                    ),             
                    array(
                        'id'        => 'newmwxicomenu_notes',
                        'type'      => 'editor',
                        'title'     => __('New Mexico Menu Notes', 'redux-framework-demo'),
                        //'subtitle'  => __('You can use the following shortcodes in your footer text: [wp-url] [site-url] [theme-url] [login-url] [logout-url] [site-title] [site-tagline] [current-year]', 'redux-framework-demo'),
                        //'default'   => 'Powered by Redux Framework.',
                    ),
                    array(
                        'id'        => 'cateringmenu_notes',
                        'type'      => 'editor',
                        'title'     => __('Catering Menu Notes', 'redux-framework-demo'),
                        //'subtitle'  => __('You can use the following shortcodes in your footer text: [wp-url] [site-url] [theme-url] [login-url] [logout-url] [site-title] [site-tagline] [current-year]', 'redux-framework-demo'),
                        //'default'   => 'Powered by Redux Framework.',
                    ),        
                ),
                ...
                /*    array(
                    ...
                    array(
                     ...
                     array(
                        ...
                        'type' => 'background',
                        'output' => array('body'),
                        'title' => __('Body Background', 'wpf-framework-demo'),
                        'subtitle' => __('Body background with image, color, etc.', 'wpf-framework-demo'),
                    //'default' => '#FFFFFF',
                    ),
                    array(
